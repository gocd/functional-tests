...
* Disabling a "Idle" and "Enabled" agent should return "200"
* Disabling a "Missing" and "Disabled" agent should return "200"
* Enabling a "Idle" and "Enabled" agent should return "200"
* Deleting a "Idle" and "Enabled" agent should return "406"
* Verify "Pending" agent count is "0"
* Verify "Enabled" agent count is "3"
* Verify "Disabled" agent count is "2"
* Enabling a "Missing" and "Disabled" agent should return "200"
* Verify "Pending" agent count is "0"
* Verify "Enabled" agent count is "4"
* Verify "Disabled" agent count is "1"
* Deleting a "Missing" and "Disabled" agent should return "200"
