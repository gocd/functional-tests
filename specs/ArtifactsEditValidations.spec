...
* ArtifactsValidation 
     ...
     |-------|------------|---------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|--------|
     |#      |../../      |Error when processing params for '#' used in field 'source', # must be followed by a parameter pattern or escaped by another #      |Invalid destination path. Destination path should match the pattern (([.]\\/)?[.][^. ]+)|([^. ].+[^. ])|([^. ][^. ])|([^. ])           |Save failed, see errors below|true    |
     |#source|#destination|Error when processing params for '#source' used in field 'source', # must be followed by a parameter pattern or escaped by another #|Error when processing params for '#destination' used in field 'destination', # must be followed by a parameter pattern or escaped by another #|Save failed, see errors below|true    |
