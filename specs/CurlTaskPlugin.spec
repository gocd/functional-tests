...
* Verify task "2" is "Curl" task with cancel "Curl" and properties "SecureConnection: no, RequestType: -d, AdditionalOptions: -u admin:badger -H CONFIRM:true" that runs if state is "Passed"
