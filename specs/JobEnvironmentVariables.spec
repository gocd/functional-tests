...
* Verify console has environment variable "GO_REVISION_P4" with value "4"
* Verify console has environment variable "GO_TO_REVISION_P4" with value "4"
* Verify console has environment variable "GO_FROM_REVISION_P4" with value "4"
...
* Verify console contains artifact from "p4/README.txt" to "p4-artifact"
