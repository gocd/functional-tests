...
public class PermissionsConfiguration extends AbstractConfiguration{
	
	private Configuration config;

public PermissionsConfiguration(Configuration config, ScenarioState state, RepositoryState repositoryState, ScenarioHelper scenarioHelper, Browser browser) throws Exception {
	super("/config/permissions-cruise-config.xml", config, state, repositoryState, scenarioHelper, browser);
	this.config = config;
}

@com.thoughtworks.gauge.Step("Permissions configuration - setup")
@Override
