...
public class AuthSSLKeyManagerFactory {
    ...
    public AuthSSLKeyManagerFactory(File keystoreFile, String keystorePassword, KeyStoreManager keyStoreManager) {
    ...
    public KeyManager[] keyManagers() {
        try {
            KeyStore store = keyStoreManager.loadOrEmpty(keystoreFile, keystorePassword);
