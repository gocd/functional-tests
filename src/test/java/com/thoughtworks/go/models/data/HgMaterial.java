...
public class HgMaterial extends Material {
    private String url;
    private String branch;

    public HgMaterial(String name, String destination, String ignoreFields, boolean autoUpdate, String url, String branch) {
